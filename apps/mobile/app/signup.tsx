...
import { PERSONA_LABELS, PERSONA_DESCRIPTIONS, type UserPersona } from '../src/constants/shared'
          ...
          {step === 2 && (
            <View>
              ...
              <Text style={s.subtitle}>
                FlowMind personalises your AI assistant to match your lifestyle.
              </Text>
              ...
              <View style={s.personaGrid}>
                {PERSONAS.map(([id, label]) => (
                  ...
                  >
                    ...
                    <Text style={[s.personaLabel, persona === id && s.personaLabelActive]}>
                      {label}
                    </Text>
...
const s = StyleSheet.create({
  ...
  container:          { flexGrow: 1, paddingHorizontal: Spacing.xl, paddingTop: Spacing.lg, paddingBottom: 60 },
  header:             { flexDirection: 'row', alignItems: 'center', gap: Spacing.md, marginBottom: 40 },
  ...
  errorBox:           { backgroundColor: '#fff0f0', borderColor: Colors.coral, borderWidth: 1, borderRadius: Radius.md, padding: Spacing.md, marginBottom: Spacing.md },
  errorText:          { fontSize: FontSize.sm, color: Colors.coral },
  title:              { fontSize: FontSize.xxl, color: Colors.textPrimary, fontWeight: '800', marginBottom: 6 },
  subtitle:           { fontSize: FontSize.sm, color: Colors.textSecondary, marginBottom: 40, lineHeight: 20 },
